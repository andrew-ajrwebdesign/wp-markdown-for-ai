...
class ComposerStaticInit437fd77f8730acd9af5b6ddef6c1f9e4
{
    ...
    public static $classMap = array (
        'AJR\\MarkdownForAI\\Cache' => __DIR__ . '/../..' . '/includes/class-cache.php',
        'AJR\\MarkdownForAI\\Indexability' => __DIR__ . '/../..' . '/includes/class-indexability.php',
        'AJR\\MarkdownForAI\\Llms_Txt' => __DIR__ . '/../..' . '/includes/class-llms-txt.php',
        'AJR\\MarkdownForAI\\Markdown_Converter' => __DIR__ . '/../..' . '/includes/class-markdown-converter.php',
        'AJR\\MarkdownForAI\\Rate_Limiter' => __DIR__ . '/../..' . '/includes/class-rate-limiter.php',
        'AJR\\MarkdownForAI\\Rest_Api' => __DIR__ . '/../..' . '/includes/class-rest-api.php',
        'AJR\\MarkdownForAI\\Rewrite_Rules' => __DIR__ . '/../..' . '/includes/class-rewrite-rules.php',
        'AJR\\MarkdownForAI\\Settings' => __DIR__ . '/../..' . '/includes/class-settings.php',
        'AJR\\MarkdownForAI\\Sitemap' => __DIR__ . '/../..' . '/includes/class-sitemap.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit437fd77f8730acd9af5b6ddef6c1f9e4::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit437fd77f8730acd9af5b6ddef6c1f9e4::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit437fd77f8730acd9af5b6ddef6c1f9e4::$classMap;
